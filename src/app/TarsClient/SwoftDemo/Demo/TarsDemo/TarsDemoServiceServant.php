...
namespace App\TarsClient\SwoftDemo\Demo\TarsDemo;
...
use App\TarsClient\SwoftDemo\Demo\TarsDemo\classes\LotofTags;
use App\TarsClient\SwoftDemo\Demo\TarsDemo\classes\SimpleStruct;
use App\TarsClient\SwoftDemo\Demo\TarsDemo\classes\OutStruct;
use App\TarsClient\SwoftDemo\Demo\TarsDemo\classes\ComplicatedStruct;
class TarsDemoServiceServant {
	protected $_communicator;
	protected $_iVersion;
	protected $_iTimeout;
	public $getrequest = false;
	public $getresponse = true;
	public $notinvoke = false;
	public $responseBuffer;
	public $_servantName = "SwoftDemo.Demo.TarsDemo";

	public function __construct(CommunicatorConfig $config, $notinvoke = false) {
		try {
	...
	public function testTafServer() {
		try {
			if (!$this->getresponse || !$this->notinvoke) {
